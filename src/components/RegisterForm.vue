<template>
  ...
  <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
    <!-- Name -->
    <div class="mb-3">
      <label class="inline-block mb-2">İsim</label>
    ...
    <!-- Age -->
    <div class="mb-3">
      <label class="inline-block mb-2">Yaş</label>
    ...
    <!-- Password -->
    <div class="mb-3">
      <label class="inline-block mb-2">Şifre</label>
    ...
    <!-- Confirm Password -->
    <div class="mb-3">
      <label class="inline-block mb-2">Şifre Onayla</label>
    ...
    <!-- Country -->
    <div class="mb-3">
      <label class="inline-block mb-2">Şehir</label>
    ...
    <div class="mb-3 pl-6">
      ...
      <label class="inline-block">kabul et</label>
...
export default {
  ...
  methods: {
    async register(values) {
      ...
      this.reg_alert_msg = 'Lütfen bekleyin!Hesabınız oluşturuluyor.';
      ...
      try {
        ...
        this.reg_alert_msg = 'Beklenmeyen bir hata oluştu.Lütfen daha sonra tekrar deneyin.';
        return;
      }

      this.reg_alert_variant = 'bg-green-500';
      this.reg_alert_msg = 'Başarılı!Hesabınız oluşturuldu';
