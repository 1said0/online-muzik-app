import { FieldContext as FieldContext$1 } from 'packages/shared';
...
declare type GenericValidateFunction = (value: unknown, ctx: FieldContext$1) => boolean | string | Promise<boolean | string>;
...
declare type RuleExpression = string | Record<string, unknown> | GenericValidateFunction | YupValidator | undefined;
/**
 * Creates a field composite.
 */
declare function useField<TValue = unknown>(name: MaybeReactive<string>, rules?: MaybeReactive<RuleExpression>, opts?: Partial<FieldOptions<TValue>>): FieldComposable<TValue>;
